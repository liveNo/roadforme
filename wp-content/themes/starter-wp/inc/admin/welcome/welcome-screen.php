   ...
   public function igthemes_welcome_admin_notice() {
    ...
    <div class="updated notice is-dismissible">
        <p>
            ...
            echo sprintf( esc_html__('! You can read documentation to how get the most out of your new theme on the %swelcome screen%s.', 'starter-wp' ), '<a href="' . esc_url( admin_url( 'themes.php?page=igthemes-welcome' ) ) . '">', '</a>' ); ?>
        </p>
        <p>
