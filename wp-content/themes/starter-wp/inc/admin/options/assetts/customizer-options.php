...
//Images
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'blog-layout', array(
        'label' => esc_html__('Blog layout', 'starter-wp'),
        'description' => esc_html__('', 'starter-wp'),
...
//main layout
    ...
    $wp_customize->add_control(
            ...
            array(
                'label'			=> __( '', 'starter-wp' ),
                'description'	=> __( 'Select the blog layout', 'starter-wp' ),
                'priority' =>   2, 
                'type'          => 'radio-image',
                'section'		=> 'layout-settings',
...
//main post content
    ...
    $wp_customize->add_control('main_post_content', array(
        'label' => esc_html__('Display full posts content', 'starter-wp'),
        'description' => esc_html__('', 'starter-wp'),
        'type' => 'checkbox',
        'section' => 'layout-settings',
...
//Images
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'images', array(
        'label' => esc_html__('Images', 'starter-wp'),
        'description' => esc_html__('', 'starter-wp'),
        'section' => 'layout-settings',
        'settings' => 'images',
        'priority'   => 5,
...
//main featured images
    ...
    $wp_customize->add_control('main_featured_images', array(
        'label' => esc_html__('Display posts featured images', 'starter-wp'),
        'description' => esc_html__('', 'starter-wp'),
        'type' => 'checkbox',
        'section' => 'layout-settings',
...
//Navigation
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'navigation', array(
        'label' => esc_html__('Navigation', 'starter-wp'),
        'description' => esc_html__('', 'starter-wp'),
        'section' => 'layout-settings',
        'settings' => 'navigation',
        'priority'   => 8,
...
//breadcrumb
    ...
    $wp_customize->add_control(
        'breadcrumb',
        array(
            'label'         => esc_html__('Display breadcrumb?', 'starter-wp'),
            'description'   => __( 'Yoast Breadcrumb supported<br>NavXT Breadcrumb supported', 'starter-wp'),
            'priority'      =>  9, 
            'type'          => 'checkbox',
            'section'       => 'layout-settings',
            'settings'      => 'breadcrumb',
...
//numeric_pagination
    ...
    $wp_customize->add_control(
        'numeric_pagination',
        array(
            'label'         => esc_html__('Use numeric pagination ?', 'starter-wp'),
            'description'   => __( 'WP-PageNavi supported', 'starter-wp'),
            'priority'      => 10,
            'type'          => 'checkbox',
            'section'       => 'layout-settings',
...
//Header Colors
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'header-colors', array(
        'label' => esc_html__('Colors', 'starter-wp'),
        'description' => esc_html__('', 'starter-wp'),
...
//header color
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_background_color',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Background color', 'starter-wp'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header text color
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_text_color',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Text color', 'starter-wp'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header link normal
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_link_normal',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Link color', 'starter-wp'),
                'type' => 'color',
                'section' => 'header-settings',
...
//header link hover
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'header_link_hover',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Link hover color', 'starter-wp'),
                'type' => 'color',
                'section' => 'header-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'body_text_color',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Body text color', 'starter-wp'),
                'priority' => 1,
                'type' => 'color',
                'section' => 'typography-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'body_headings_color',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Headings color', 'starter-wp'),
                'priority' => 2,
                'type' => 'color',
                'section' => 'typography-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_background_hover',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Background hover', 'starter-wp'),
                'priority' => 2,
                'type' => 'color',
                'section' => 'buttons-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_text_normal',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Text normal', 'starter-wp'),
                'priority' => 3,
                'type' => 'color',
                'section' => 'buttons-settings',
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'button_text_hover',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Text hover', 'starter-wp'),
                'priority' => 4,
                'type' => 'color',
                'section' => 'buttons-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control(
        ...
        $wp_customize, 'footer_headings_color',
            array(
                'label' => __('', 'starter-wp'),
                'description' => __('Hedings color', 'starter-wp'),
                'priority' => 3,
                'type' => 'color',
                'section' => 'footer-settings',
...
//facebook
    ...
    $wp_customize->add_control('facebook_url', array(
        'label' => esc_html__('Facebook url', 'starter-wp'),
        'type' => 'url',
...
//twitter
    ...
    $wp_customize->add_control('twitter_url', array(
        'label' => esc_html__('Twitter url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
...
//google
    ...
    $wp_customize->add_control('google_url', array(
        'label' => esc_html__('Google plus url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
        'settings' => 'google_url',
    ));
//pinterest
    ...
    $wp_customize->add_control('pinterest_url', array(
        'label' => esc_html__('Pinterest url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
...
//tumblr
    ...
    $wp_customize->add_control('tumblr_url', array(
        'label' => esc_html__('Tumblr url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
        'settings' => 'tumblr_url',
    ));
//instagram
    ...
    $wp_customize->add_control('instagram_url', array(
        'label' => esc_html__('Instagram url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
...
//linkedin
    ...
    $wp_customize->add_control('linkedin_url', array(
        'label' => esc_html__('Linkedin url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
...
//dribbble
    ...
    $wp_customize->add_control('dribbble_url', array(
        'label' => esc_html__('Dribble url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
...
//youtube
    ...
    $wp_customize->add_control('youtube_url', array(
        'label' => esc_html__('Youtube url', 'starter-wp'),
        'type' => 'url',
        'section' => 'social-settings',
